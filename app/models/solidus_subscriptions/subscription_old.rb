...
#     belongs_to :supplier, class_name: 'Spree::Supplier', inverse_of: :subscriptions
...
#     delegate :delivery_interval, :delivery_interval_units, :delivery_interval_length, to: :line_item
#     delegate :bill_interval,     :bill_interval_units,     :bill_interval_length,     to: :line_item
#     delegate :contract_interval, :contract_interval_units, :contract_interval_length, to: :line_item
#     delegate :interval,          :interval_units,          :interval_length,          to: :line_item
...
#           line_item.spree_line_item.inventory_units.first.shipment.can_be_activated?
#     end
...
#       (new_date + (line_item.delivery_interval || line_item.bill_interval)).beginning_of_minute
#     end
...
#     def subscription_preset
#       line_item.subscription_preset
#     end
