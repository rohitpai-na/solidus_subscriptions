...
attributes :id, :number, :item_total, :total, :ship_total, :included_tax_total, :tax_total, :payment_total, :currency, :user_id, :email, :state, :shipment_state, :payment_state, :created_at, :updated_at, :completed_at 
